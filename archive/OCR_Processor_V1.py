...
class OCRProcessor:
    ...
    def perform_ocr(self, image_path, conf_threshold:int=60):
        """
    ...
    def demo(self, image_filepath: str):
        ...
        try:
            ...
            json_results = self.perform_ocr(image_path)
...
ocr = OCRProcessor('C:/Program Files/Tesseract-OCR/Tesseract.exe')
ocr.demo("TEST_IMAGE.png")

# main_func("Wege_der_parlamentarischen_Demokratie.jpg")
# main_func("sample.jpg")
# main_func("Screenshot 2024-11-24 193229.png")
# main_func("Screenshot 2024-11-24 185300.png")
# main_func("Screenshot 2024-11-24 192646.png")
# main_func("Screenshot 2024-11-24 193229.png")