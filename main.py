...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('keypress_log.txt')
    ]
)
...
class KeyDetector:
    """Detects different types of key presses with improved hold detection"""
    ...
    def __init__(self, key, press_callback):
        ...
        self.tap_threshold = 0.3  # seconds between taps to count as multi-tap
